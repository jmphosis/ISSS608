...
However, the `mutate_each_()` function was deprecated in dplyr 0.7.0. and the `funs()` function was deprecated in dplyr 0.8.0. In view of this, the code chunk is rewritten using the [`mutate_at()`](https://dplyr.tidyverse.org/reference/mutate_all.html) function in the **dplyr** package.
