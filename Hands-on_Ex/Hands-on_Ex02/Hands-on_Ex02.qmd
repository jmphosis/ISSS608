...
The previous plot is re-plotted by replacing the `geom_label()` function in the **ggplot2** package with the [`geom_label_repel()`](https://ggrepel.slowkow.com/reference/geom_text_repel.html) function in the **ggrepel** package.
...
The previous plot is re-plotted with *The Economist* theme below.
...
The previous plot is re-plotted with the `theme_ipsum` function below, with the addition of the following arguments:
...
-   () (parenthesis) to create a subplot group; and
